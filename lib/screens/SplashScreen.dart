    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ClipRRect(borderRadius: radius(50), child: Image.asset(ic_logo_white,fit: BoxFit.contain, width: 150, height: 150)),
            SizedBox(height: 16),
            Text(language.appName, style: boldTextStyle(color: Colors.black, size: 22)),
          ],
        ),
      ),
    );
